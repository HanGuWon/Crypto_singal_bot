...
| Cross-exchange canonical asset mapping | Implemented with MVP limitations | Symbol normalization exists, but full cross-exchange identity mapping remains simple |
